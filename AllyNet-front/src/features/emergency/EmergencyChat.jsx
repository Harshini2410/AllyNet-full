            ...
            messages.map((message) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "flex gap-2 w-full",
                    isMine ? "justify-end items-end" : "justify-start items-end"
                  )}
                >
                  {!isMine && (
                    <div className="w-8 h-8 bg-coral-500 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 order-1">
                      {displayInitials}
                    </div>
                  )}
                  ...
                  <div className={cn(
                    ...
                    isMine 
                      ? "bg-coral-500 text-white rounded-br-sm order-2" 
                      : "bg-white text-charcoal-700 border border-sand-200 rounded-bl-sm order-2"
                  )}>
                    {!isMine && (
                  ...
                  {isMine && (
                    <div className="w-8 h-8 bg-coral-500 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 order-3">
                      {displayInitials}
                    </div>
                  )}
                </motion.div>
