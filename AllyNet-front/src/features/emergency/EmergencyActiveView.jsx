...
const EmergencyActiveView = () => {
  ...
  const [emergencyData, setEmergencyData] = useState(null); // Store full emergency data for map
    ...
    const fetchEmergencyData = async () => {
      ...
      try {
        ...
        if (response?.success && response?.data?.emergency) {
          ...
          // Store full emergency data for map
    ...
    <div className="fixed inset-0 bg-sand-100 z-[100] flex flex-col overflow-hidden">
      ...
      <div className="absolute bottom-6 left-6 right-6 flex justify-end items-end gap-2">
        ...
        <button 
          ...
          className="bg-white/90 backdrop-blur p-3 rounded-2xl shadow-md text-charcoal-500 hover:bg-white transition-colors"
                ...
                <Button 
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const response = await emergencyApi.resolveEmergency(emergencyId, 'user_resolved', null);
                      ...
                      const errorMessage = error?.message || error?.error?.message || 'Failed to stop emergency. Please try again.';
                      alert(errorMessage);
                    } finally {
