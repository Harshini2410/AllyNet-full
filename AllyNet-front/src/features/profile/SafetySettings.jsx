...
import { ArrowLeft, Plus, Trash2, Phone, User as UserIcon } from 'lucide-react';
...
const SafetySettings = () => {
  ...
  const handleAddContact = async (e) => {
    ...
    try {
      setAdding(true);
      setError(null);
      const response = await api.addEmergencyContact(formData.name.trim(), formData.phone.trim());
      if (response?.success) {
      ...
      <div className="px-6 py-6 space-y-4">
        ...
        <Card className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
          <p className="text-sm text-amber-800 dark:text-amber-200">
            <strong>Emergency Contacts:</strong> Add trusted contacts who will receive SMS notifications with your location when you trigger an emergency. These contacts will be notified regardless of distance.
          </p>
        </Card>
        ...
        <div>
          ...
          {contacts.length === 0 ? (
            <Card className="p-8 text-center">
              <Phone size={48} className="mx-auto mb-4 text-charcoal-300 dark:text-sand-500" />
              ...
              <p className="text-sm text-charcoal-300 dark:text-sand-400">
                Add contacts to receive SMS notifications when you trigger an emergency.
              </p>
            </Card>
          ) : (
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          <Phone size={14} className="text-charcoal-300 dark:text-sand-500" />
