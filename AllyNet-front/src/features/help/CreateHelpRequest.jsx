  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestData = {
        ...
        radiusKm: formData.radiusKm, // User-selected radius (5, 10, 15, 20 km)
        location: {
          latitude,
          longitude,
          address: null,
      ...
      if (response?.success) {
        ...
        setFormData({ title: '', category: 'Physical', priority: 'low', budget: '', description: '', radiusKm: 10 });
        onClose();
      } else {
        ...
        <>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 pb-8">
              ...
              {/* Radius Selection */}
              <div>
                <label className="text-[10px] font-bold uppercase tracking-widest text-sage-600 block mb-2">Search Radius *</label>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        formData.radiusKm === radius
                          ...
                          : 'bg-white text-charcoal-300 border border-sand-200'
                      )}
                    >
                      {radius} km
                    </button>
                ...
                <p className="mt-2 text-xs text-charcoal-400 dark:text-sand-400">
                  Helpers within {formData.radiusKm} km will see your request
                </p>
              </div>
