...
const EmergencyNotification = () => {
  ...
  useEffect(() => {
    ...
    const checkEmergency = async () => {
      try {
        ...
        // If emergency is not active, clear notification
  ...
  // FINAL VALIDATION 1: Emergency must be active (not resolved, cancelled, or responding)
  if (nearbyEmergency.status !== 'active') {
    // Emergency is not active - clear notification
    dismissEmergencyNotification();
    return null;
  }
