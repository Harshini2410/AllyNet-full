...
const EmergencyNotification = () => {
  ...
  // CRITICAL: If emergency doesn't have required fields, don't show
  const notificationEmergencyId = nearbyEmergency._id || nearbyEmergency.id;
  ...
  const emergencyIdFromNotification = notificationEmergencyId;
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() => {
                    const navEmergencyId = notificationEmergencyId;
                    if (navEmergencyId) {
                      // Navigate to emergency details (does NOT auto-join or open chat)
                      navigate(`/emergencies/${navEmergencyId}`);
                      dismissEmergencyNotification();
                    }
                  }}
                >
