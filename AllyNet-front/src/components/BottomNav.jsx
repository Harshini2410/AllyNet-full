...
const BottomNav = ({ activeTab, onTabChange, onSOSClick }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-charcoal-800/80 backdrop-blur-lg border-t border-sand-200 dark:border-charcoal-700 px-6 pb-4 pt-2 z-50">
